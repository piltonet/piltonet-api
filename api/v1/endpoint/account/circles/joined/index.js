...
class leaf { // Required
  constructor(){
    this.__uri__ = '/account/circles/joined'; // Required: Defining new leaf under /v1/
    this.__path__ = 'v1/endpoint/account/circles/joined'; // Optional: path of file
...
async function getAccountInvitedCircle(http_request, response){
  ...
  */
  ...
  /***************** Get Circle Members *******************/
  dbMembers = await models.queries.select_table('circles_members',
    {
      circle_id: params.verifiedParams.circle_id,
      member_status: 'joined'
