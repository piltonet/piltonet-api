...
class leaf { // Required
  constructor(){
    this.__uri__ = '/account/link/reject'; // Required: Defining new leaf under /v1/
    this.__path__ = 'v1/endpoint/account/link_reject'; // Optional: path of file
    ...
    this.__methods__ = { // Methods and Resposible Functions
      'post': linkReject // Setting for each http method a function
    };
  }
}
...
/*********************************************************************************************************************/
/*********************************************************************************************************************/
async function linkReject(http_request, response){
  ...
  resp.message = 'The link request was successfully rejected.';
  resp.result = [];
  response.status(200);
  response.json(resp);
  return
